...
export const STORY_BRANCHES = {
    ...
    prologue: {
        ...
        options: [
            { id: 'prologue_listen', text: 'Lausche dem Flüstern genauer...', next: 'prologue_voice' },
            { id: 'prologue_stand', text: 'Raffe dich auf und blicke um dich', next: 'prologue_landscape' }
        ],
        flags: { prologue_started: true }
    },
    ...
    prologue_labyrinth: {
        ...
        options: [
            { id: 'prologue_lab_mira', text: 'Nähere dich der Laterne und der Gestalt', next: 'chapter1_coward' },
            { id: 'prologue_lab_deeper', text: 'Ignoriere sie und tauche tiefer in die verbotenen Schriften', next: 'chapter1_coward_deeper' }
        ],
        flags: { prologue_completed: true, coward_path: true }
    },
    ...
    chapter1_hero: {
        ...
        options: [
            { id: 'ch1_hero_attack', text: 'Gehe zum Frontalangriff über und zerschmettere den Schatten!', next: 'chapter1_hero_victory' }
        ],
    ...
    chapter1_hero_spared: {
        ...
        options: [
            { id: 'ch1_spared_continue', text: 'Setze den Weg zum Auge des Archivs fort', next: 'chapter2_approach' }
        ],
        flags: { hero_path: true, malakor_spared: true, secret_known: true, boss_defeated_1: true }
    },
    ...
    chapter1_hero_victory: {
        ...
        options: [
            { id: 'ch1_vic_continue', text: 'Folge dem Weg zum Auge des Archivs', next: 'chapter2_approach' }
        ],
        flags: { hero_path: true, boss_defeated_1: true, elara_watched: true }
    },

    // =====================================================================
    // KAPITEL 1 – FEIGLINGS- / EXIL-PFAD
    // =====================================================================
    chapter1_coward: {
        id: 'chapter1_coward',
    ...
    chapter1_coward_return: {
        ...
        options: [
            { id: 'ch1_cr_continue', text: 'Setze den Weg zum Auge des Archivs fort', next: 'chapter2_approach' }
        ],
        flags: { coward_path: true, redemption_path: true }
    },
    ...
    chapter2_approach: {
        ...
        options: [
            { id: 'ch2_app_enter', text: 'Betrete die Plattform', next: 'chapter2_confrontation' }
        ],
        flags: { chapter2_reached: true }
    },
    ...
    chapter2_lone_choice: {
        ...
        options: [
            { id: 'ch2_lc_continue', text: 'Setze deinen eigenen Weg fort', next: 'chapter3_lone_wolf' }
        ],
        flags: { lone_wolf_path: true }
    },

    // =====================================================================
    // KAPITEL 3 – Ideologien
    // =====================================================================
    chapter3_guardian: {
        ...
        options: [
            { id: 'ch3_g_fight', text: 'Stelle dich der heraufziehenden Flut und vernichte das Vergessen', next: 'chapter3_guardian_war' },
            { id: 'ch3_g_seal', text: 'Versiegle das gesamte Archiv für immer und konserviere den Status quo', next: 'chapter4_seal' },
            { id: 'ch3_g_doubt', text: 'Zweifle – vielleicht ist der Bund selbst Teil des Problems', next: 'chapter3_guardian_doubt' }
        ],
    ...
    chapter3_guardian_war: {
        ...
        options: [
            { id: 'ch3_gw_epic', text: 'Bereite dich auf die finale Konfrontation vor', next: 'chapter4_epic' }
        ],
        flags: { guardian_path: true, war_declared: true }
    },
    ...
    chapter4_epic: {
        ...
        options: [
            { id: 'ch4_e_win', text: 'Besiege das Vergessen und rette das Archiv', next: 'ending_victory' },
            { id: 'ch4_e_sacrifice', text: 'Opfere deinen eigenen Verstand, um den Abgrund in dir zu versiegeln', next: 'ending_sacrifice' }
        ],
    ...
    chapter4_seal: {
        ...
        options: [
            { id: 'ch4_s_eternal', text: 'Nimm Platz auf dem Thron der Stasis und wache bis ans Ende aller Zeiten', next: 'ending_eternal' }
        ],
    ...
    chapter4_rebel: {
        ...
        options: [
            { id: 'ch4_r_victory', text: 'Stürze den Orden und befreie alle Erinnerungen in die Wildnis', next: 'ending_rebel' },
            { id: 'ch4_r_tyrant', text: 'Reiße die Krone an dich und regiere selbst mit eiserner Hand', next: 'ending_tyrant' },
            { id: 'ch4_r_mercy', text: 'Verschone den Orden und erzwinge einen neuen Bund des Wandels', next: 'ending_free' }
        ],
    ...
    chapter4_god: {
        ...
        options: [
            { id: 'ch4_g_rule', text: 'Etabliere eine unfehlbare, göttliche Herrschaft', next: 'ending_ruler' },
            { id: 'ch4_g_free', text: 'Sprenge deine Form und zerstreue die Mneme als neuen Sternenstaub', next: 'ending_free' }
        ],
        flags: { god_path: true }
    },
    ...
    chapter4_guardian_teach: {
        ...
        options: [
            { id: 'ch4_gt_epic', text: 'Führe den Orden in einen neuen Krieg – mit neuem Verständnis', next: 'chapter4_epic' },
            { id: 'ch4_gt_seal', text: 'Trotzdem versiegeln – das Risiko ist zu groß', next: 'chapter4_seal' }
        ],
        flags: { scholar_path: true, order_taught: true }
    },
    ...
    chapter4_void_path: {
        ...
        options: [
            { id: 'ch4_v_void', text: 'Sinke mit allem in das warme Nichts', next: 'ending_void' },
            { id: 'ch4_v_last', text: 'Halte einen letzten Funken Mneme fest und werde zum Samen einer neuen Welt', next: 'ending_free' }
        ],
        flags: { void_path: true }
    },
